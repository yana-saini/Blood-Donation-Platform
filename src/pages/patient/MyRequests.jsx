    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="p-6">
        ...
        {!loading && requests.length === 0 && (
          <p className="text-neutral-500">You haven't sent any requests yet.</p>
        )}
        ...
        <div className="space-y-3">
          {requests.map((req) => (
            <div
              key={req.id}
              className="bg-neutral-900 border border-red-900 rounded-lg p-4 flex justify-between items-center"
            >
              <div>
